...
def utilityfunc(n_clicks, value1, value2, value3, value4):
    
    fig = go.Figure(
            layout=go.Layout(
                    xaxis={
                        'rangeslider': {'visible':True},
                        'rangeselector': {'visible':True, 'buttons':[{'step':'all'}]},
                        'tickformat' : '%',
                        'range' : [0,1]
                    },
                    yaxis=dict(
    ...
    print('len(y_t):', len(y_test_T))
    print('total_no_queries:', total_no_queries)
    ...
    return dcc.Markdown(sen,style={'color': colors['text']}), fig#, dcc.Markdown(sen, id= 'report-text')
    
    

    #data = cost_benefit_analysis(y_test_T,
    #                                         probas,
    #                                         perc_contacted=PERCENT_TO_AUTOMATE,
    #                                         total_applicable_customers=total_no_queries,
    #                                         cost_of_reviewing_query = value1,
    #                                         cost_of_false_negative = value2)
...
#def plotfunc(utility):
#    print('it got to the figure display')
#    utility2 = [0] + list(utility.saving)
...
#    fig = go.Figure(
            ...
            #    )
#            )
#    fig.add_trace(go.Scatter(x=x_axis, y=utility2, fill='tozeroy',
#                    mode='none' # override default markers+lines
#                    ))
#    return fig
